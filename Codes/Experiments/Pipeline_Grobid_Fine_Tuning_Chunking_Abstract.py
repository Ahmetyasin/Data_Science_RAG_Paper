...
all_results.to_csv('./Results/Results_pipeline_grobid_fine_tuning_chunking_abstract.csv', index=False)
print("All runs completed and results saved to ./Results/Results_pipeline_grobid_fine_tuning_chunking_abstract.csv")
