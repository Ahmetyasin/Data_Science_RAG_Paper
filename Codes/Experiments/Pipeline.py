...
vectorstore = Chroma(persist_directory="../Vector_DB/chroma_baseline", embedding_function=embeddings)
...
all_results.to_csv('./Results/Results_pipeline_baseline.csv', index=False)
print("All runs completed and results saved to ./Results/Results_pipeline_baseline.csv")
