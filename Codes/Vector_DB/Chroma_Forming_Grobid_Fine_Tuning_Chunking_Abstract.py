...
# Example usage
docs = load_documents('Document_list_summary.pkl')
...
vectorstore = Chroma.from_documents(documents=splits, embedding=embeddings, persist_directory="./chroma_grobid_fine_tuned_chunking_abstract")
print(vectorstore)
